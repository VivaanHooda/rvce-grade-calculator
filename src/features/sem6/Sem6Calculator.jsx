        ...
        return (
            <div className="space-y-8 animate-fade-in">
                <div className="flex items-center justify-between mb-8">
                    <button
                        onClick={onBack}
                        className="text-brand hover:text-brand-hover font-medium text-lg transition-colors flex items-center gap-1"
                    >
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="bg-white border border-hairline rounded-panel p-8 shadow-card mt-8">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-xl font-bold text-ink">CGPA up to 5th Sem</h3>
                        ...
                        <div className="bg-gray-50 rounded-xl p-4 border border-hairline">
                            <label className="text-ink font-medium block mb-2">Enter your CGPA up to 5th Semester</label>
                            <input
                                type="text"
                                inputMode="decimal"
                                value={prevSemCGPA}
    ...
    return (
        <div className="space-y-6 sm:space-y-8 animate-fade-in">
            <div className="px-4">
                <button
                    onClick={() => setCurrentMode('')}
                    className="text-brand hover:text-brand-hover font-medium text-base sm:text-lg transition-colors mb-4 flex items-center gap-1"
                >
                    <span>←</span> Back to Modes
                </button>
