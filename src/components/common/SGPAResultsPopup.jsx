    ...
    <div className="flex items-center justify-center p-4 modal-backdrop glass-dark z-modal animate-fade-in" onClick={onClose}>
      <div className="w-full max-w-md p-6 bg-white rounded-panel sm:p-8 shadow-modal animate-slide-up" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <h3 className="text-xl font-bold sm:text-2xl text-ink">SGPA Results</h3>
          <button
            onClick={onClose}
        ...
        <div className="mb-3 text-center sm:mb-4">
          <div className="mb-2 text-base font-semibold sm:text-lg text-ink-muted">{cycleName}</div>
          <div className="mb-2 text-4xl font-bold tracking-tight sm:text-5xl text-ink">{sgpa}</div>
          <div className="text-base text-ink-muted sm:text-lg">SGPA out of 10</div>
        </div>
